...
RSpec.feature "Task management function", type: :feature do
  ...
  scenario "Test task list" do
    ...
    Task.create!(name: 'test_task_01', status: 'test_task_01', content: 'testtesttest', prior: 'medium', user_id: '4', start_date: '10.2.2019', end_date: '10.2.2019')
    Task.create!(name: 'test_task_02', status: 'test_task_02', content: 'samplesample', prior: 'medium', user_id: '4', start_date: '10.2.2019', end_date: '10.2.2019')
...
expect(page ).to  have_content  'ruby task'
  ...
  scenario "Test task details" do
    @task = Task.create!(name: 'test_task_01', content: 'testtesttest', status: 'completed', prior: 'medium', user_id: '4', start_date: '10.2.2019', end_date: '20.10.2019')
    visit task_path(id: @task.id)
    expect(page).to have_content('test_task_01')
    expect(page).to have_content('testtesttest')
  end
  scenario "Test whether tasks are arranged in descending order of creation date" do
    Task.create!(name: 'test_task_01', content: 'testtesttest', status: 'completed', prior: 'medium', user_id: '4', start_date: '10.2.2019', end_date: '20.10.2019')
    Task.create!(name: 'test_task_02', content: 'testtesttest2', status: 'completed', prior: 'medium', user_id: '4', start_date: '10.2.2019', end_date: '20.10.2019')
    @task = Task.order('created_at ASC')
  end
  scenario "Test task updating" do
    task1=Task.create!(name: 'test_task_01', content: 'testtesttest', status: 'completed', prior: 'medium', user_id: '4', start_date: '10.2.2019', end_date: '20.10.2019')
